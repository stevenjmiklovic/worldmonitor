...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  game: {
    title: 'The Great Game - Geopolitical Strategy Simulation',
    description: 'A single-player geopolitical strategy simulation built on the World Monitor intelligence dashboard. Manage resources, deploy agents, and shape the global order.',
    keywords: 'geopolitical simulation, strategy game, intelligence game, great game, world simulation, geopolitics, turn-based strategy, global intelligence, OSINT game',
    url: 'https://game.worldmonitor.app/',
    siteName: 'The Great Game',
    shortName: 'GreatGame',
    subject: 'Geopolitical Strategy Simulation and Intelligence Training',
    classification: 'Strategy Simulation, Intelligence Dashboard, Serious Game',
    categories: ['games', 'education'],
    features: [
      'Turn-based geopolitical simulation',
      'Resource management (political, intel, military, economic, tech)',
      'Regional influence & stability tracking',
      'Intelligence briefings with world events',
      'Strategic action selection',
      'Objective-based scoring',
      'Real-time map visualization of game state',
      'Event log & post-game analysis',
    ],
  },
};
