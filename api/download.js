...
const RELEASES_URL = 'https://api.github.com/repos/stevenjmiklovic/worldmonitor/releases/latest';
const RELEASES_PAGE = 'https://github.com/stevenjmiklovic/worldmonitor/releases/latest';
